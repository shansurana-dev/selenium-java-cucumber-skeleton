package Com.Test.Shanthilal.setup;
...
import static Com.Test.Shanthilal.utilities.Tools.border;
...
public class Config {
  ...
  private static String env = getProperty("env", "http://automationpractice.com/index.php");
